...
- Yapılandırılabilir Kimlik: Sunucu kimlik dizgesi (`sshServerVersion`) konfigürasyon üzerinden ayarlanabilir (varsayılan: `SSH-2.0-Metrice_2.2.1`).
...
| `sshServerVersion` | `SSH_SERVER_VERSION` | `'SSH-2.0-Metrice_2.2.1'` | SSH sunucusu protokol kimlik dizgesi |
...
```bash
# 1. Metrice v2.2.1 Spesifikasyon ve Güvenlik Süiti
