...
- **Dynamic Version Synchronisation:** Server identification string (`sshServerVersion`) synchronizes dynamically with `package.json` (`SSH-2.0-Metrice_2.7.0`) and is configurable via `SSH_SERVER_VERSION`.
...
| `sshServerVersion` | `SSH_SERVER_VERSION` | `'SSH-2.0-Metrice_2.7.0'` | SSH server identification banner |
