...
- Yapılandırılabilir Kimlik: Sunucu kimlik dizgesi (`sshServerVersion`) konfigürasyon üzerinden ayarlanabilir (varsayılan: `SSH-2.0-Metrice_2.1.9`).
...
| `sshServerVersion` | `SSH_SERVER_VERSION` | `'SSH-2.0-Metrice_2.1.9'` | SSH sunucusu protokol kimlik dizgesi |
...
```bash
# 1. Metrice v2.1.9 Spesifikasyon ve Güvenlik Süiti
